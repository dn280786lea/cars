...
const Home = () => {
  return (
    <div className="home">
      <h1 className="title">Rent camper</h1>
      <div className="main-text">
        ...
        <p className="home-text">
          ...
          throughout Ukraine." "From the picturesque Carpathian Mountains to the
          stunning Black Sea coast, our campers provide the perfect opportunity
          to discover Ukraine's diverse landscapes and rich cultural heritage."
        </p>
